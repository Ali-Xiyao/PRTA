...
def _training_command(
    ...
    *,
    ...
    return [
        ...
        "formal",
        "--config",
        f"{{output_root}}/configs/{experiment_id}.json",
        "--split-manifest",
        "{output_root}/selection/train_only_selection_v1.jsonl",
        "--derived-train-only-selection-receipt",
        "{output_root}/selection/selection_manifest_receipt.json",
    ...
    jobs: list[dict[str, Any]] = [
        {
            ...
            "command": [
                ...
                "--config",
                f"{{output_root}}/configs/{representative}.json",
                "--split-manifest",
                "{output_root}/selection/train_only_selection_v1.jsonl",
                "--cache-root",
                inputs["cache_root"],
